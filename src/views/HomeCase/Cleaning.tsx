...
export default class Cleaning extends Vue {
        ...
        public render(h: CreateElement) {
                return (
                        <div id="Cleaning" class="swiper-container">
                                Cleaning
        ...
        public swiper() {
                let Cleaning: any = new Swiper('#Cleaning', {
                        notNextTick: true,
                        autoplay: {
                                delay: 800,
                ...
                for (let i = 0; i < this.ImgIetms.length; i++) {
                        ...
                        imgItem.push(
                                <div class="swiper-slide">
                                        <dl>
                                                <dt><img src={this.ImgIetms[i].src} alt={this.ImgIetms[i].title} /></dt>
                                                <dd><p>{this.ImgIetms[i].title}</p></dd>
                                        </dl>
                                </div>
                        )
