...
export default class Shrs extends Vue {
                        ...
                        <div class="shrs-body container-fluid mpclear">
                                <div class="head">
                                        ...
                                        <div class="hidden-sm hidden-xs pcHead">
                                                <div class="logo fl"><img src="./img/logo.png" alt="logo" /></div>
                                                <div class="menu-row fl">
                                                        <div class="menus fl">
                                                                ...
                                                                <span><router-link to="/itemCard/talents">人才招聘</router-link></span>
        ...
        public mounted() {
                ...
                swiper1.onmousedown = () => console.log(123)
                this.pcLayout()
                let resizeEnd = true
                window.onresize = () => {
                        this.pcLayout()
                        ...
                        if (resizeEnd) clearTimeout(sett);
                        var sett = setTimeout(() => {
                                // resizeEnd = false
                                console.log(1);
                        }, 3000);
                ...
                (window as any).onResizeEnd = () => console.log(123);
        }
        public destroyed() { }
